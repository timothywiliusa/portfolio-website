    ...
    >
        ...
        <div className='flex flex-col-reverse lg:flex-row gap-8 '>
          ...
          <div className='flex flex-col gap-4 text-base'>
            <p className="">
              Back in 2019, I decided to try my hand at creating a React site for a <Link href='https://www.hazadapt.com' target='_blank'  className="inlineLink">start-up</Link> with a couple of college friends and tumbled head first into the rabbit hole of coding and web development. Fast-forward to today, and I’ve had the privilege of building software for a <Link href='https://calvin-church.org' target='_blank' className="inlineLink">church</Link>, an <Link href='https://goldeneaglestaffingservices.com' target='_blank'  className="inlineLink">outsourcing company</Link>, a <Link href='https://trisakti.co.id' target='_blank'  className="inlineLink">huge corporation</Link>, and a <Link href='https://quantum-vox.com' target='_blank'  className="inlineLink">digital marketing agency</Link>.
            </p>
            <p className="">
