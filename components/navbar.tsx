          ...
          {links.map(link => (
            ...
            >
              <Link 
                className={
                  clsx(  
                    "flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 transition dark:text-gray-500 dark:hover:text-[#FF5733]" , 
                    {
                      "text-gray-950 dark:text-[#FF5733]": activeSection === link.name
                    }
                  )
                }
                href={link.hash}
